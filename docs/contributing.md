...
- Try HTTPX and [report bugs/issues you find](https://github.com/encode/httpx2/issues/new)
- [Implement new features](https://github.com/encode/httpx2/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
- [Review Pull Requests of others](https://github.com/encode/httpx2/pulls)
- Write documentation
...
Contributions should generally start out with [a discussion](https://github.com/encode/httpx2/discussions).
...
[HTTPX repository](https://github.com/encode/httpx2) on GitHub.
...
<p align="center" style="margin: 0 0 10px">
  <img src="https://raw.githubusercontent.com/encode/httpx2/master/docs/img/gh-actions-fail.png" alt='Failing PR commit status'>
</p>
...
<p align="center" style="margin: 0 0 10px">
  <img src="https://raw.githubusercontent.com/encode/httpx2/master/docs/img/gh-actions-fail-check.png" alt='Failing GitHub action lint job'>
</p>
...
<p align="center" style="margin: 0 0 10px">
  <img src="https://raw.githubusercontent.com/encode/httpx2/master/docs/img/gh-actions-fail-test.png" alt='Failing GitHub action test job'>
</p>
...
- **An update to the changelog**:
    ...
    - [Compare](https://github.com/encode/httpx2/compare/) `master` with the tag of the latest release, and list all entries that are of interest to our users:
...
For an example, see [#1006](https://github.com/encode/httpx2/pull/1006).

Once the release PR is merged, create a
[new release](https://github.com/encode/httpx2/releases/new) including:
